import {
	...
	ITEM_FIELD_KEYS,
	StoredConfig,
} from "src/items/affinity";
import { Component, OnInit } from "@angular/core";
import { FormBuilder } from "@angular/forms";
import { MatOptionSelectionChange } from "@angular/material/core";
import { ammoPressDescription, ammunition } from "src/items/ammoPress";
...
export class AppComponent implements OnInit {
	...
	readonly ammoDataSource = ammunition;
	readonly ammoPressItemDescription = ammoPressDescription;
	...
	displayedAmmoPressColumns = ["name", "cost", "weight"];
